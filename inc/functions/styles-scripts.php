...
function jumpoff_scripts_and_styles() {
	if ( !is_admin() ) {
		...
		// Example for loading on specific page(s)
		...
		// Example for loading on Single pages
		// if ( is_single() ) {
